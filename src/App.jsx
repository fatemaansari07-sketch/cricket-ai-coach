...
import { Home, Video, Calendar, Store, ArrowLeftRight, LogOut, Crown, ShieldCheck, School, TrendingUp, User } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="w-full flex justify-center" style={{ background: C.bg, height: "100dvh" }}>
      <div className="w-full max-w-md flex flex-col" style={{ background: C.app, height: "100dvh" }}>
        {/* Top bar */}
