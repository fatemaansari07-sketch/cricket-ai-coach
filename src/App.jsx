...
import { Home, Video, Calendar, Store, ArrowLeftRight, LogOut, Crown, ShieldCheck, School, TrendingUp, Gauge, Trophy } from "lucide-react";
    ...
    <div className="w-full flex justify-center" style={{ background: C.bg, height: "100vh" }}>
      <div className="w-full max-w-md flex flex-col" style={{ background: C.app, height: "100vh" }}>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4">
          ...
          {tab === "mastery" && <MasteryScreen isPaid={isPaid} setTab={setTab} />}
