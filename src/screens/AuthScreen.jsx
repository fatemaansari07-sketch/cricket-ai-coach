    ...
    <div className="w-full flex justify-center" style={{ background: C.bg, minHeight: "100vh" }}>
      <div className="w-full max-w-md flex flex-col justify-center px-6" style={{ background: C.app, minHeight: "100vh" }}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 rounded-xl py-3 mb-4 font-semibold text-sm active:scale-95 transition-transform"
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-[10px]" style={{ color: C.muted }}>YA PHIR</span>
          <div className="h-px flex-1" style={{ background: C.border }} />
        </div>
