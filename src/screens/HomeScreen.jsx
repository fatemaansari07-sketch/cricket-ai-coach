...
import { Video, Calendar, ArrowLeftRight, Upload, Crown, Sparkles, School, Gauge } from "lucide-react";
...
export default function HomeScreen({ isPaid, planTier, isAcademyOwner, setTab }) {
  const quickActions = [
    ...
    { icon: <Gauge size={18} />, label: "Speed Gun", tab: "speed" },
  ];

  const planLabel = planTier === "free" ? "Free plan" : planTier === "basic" ? "Basic · ₹99/mo" : "AI Coach Video · ₹499/mo";
