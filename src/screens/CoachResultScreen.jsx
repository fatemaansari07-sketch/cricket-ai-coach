 ...
 */
export default function CoachResultScreen({ coaching, shotType, onPlanReady, showAd, planTier, onUpgrade }) {
  ...
  const {
    ...
    rawCorrect = [], rawIncorrect = [], drillsAreVariant,
  } = coaching;
  ...
  return (
    <div className="space-y-4 pt-2">
        ...
        {drills.length > 0 && (
          <>
            <div className="text-xs font-bold mb-1.5" style={{ color: C.muted }}>
              Ye karo{drillsAreVariant ? " (naya tareeka — pehle wala kaam nahi kiya)" : ""}:
            </div>
      ...
      <SolidButton tone="green" onClick={onPlanReady}>
        30-Day Plan Dekho
      </SolidButton>
    </div>
  );
