...
export default function CoachResultScreen({
  ...
  const showSkeleton = planTier === "pro" || planTier === "basic";
  ...
  return (
    <div className="space-y-4 pt-2">
      ...
      {hasAnyThumb && skeletonLandmarks && jointStatus && planTier === "free" && (
        <button
          onClick={onUpgrade}
        ...
        >
          ...
          <span className="text-xs" style={{ color: "#D1D5DB" }}>
            <b style={{ color: C.gold }}>Paid plan me apna joint-by-joint skeleton dekho</b> — kaunsa hissa sahi hai, kaunsa galat, seedha video par.
          </span>
        </button>
      )}
