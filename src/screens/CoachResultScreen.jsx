...
export default function CoachResultScreen({
  ...
  videoThumb, videoThumbAspect, stanceThumb, stanceThumbAspect, followThroughThumb, followThroughThumbAspect,
}) {
  ...
  const showSkeleton = planTier === "pro";
  ...
  return (
    <div className="space-y-4 pt-2">
        ...
        <div>
          <div style={{ display: "flex", gap: 10, overflowX: "auto", scrollSnapType: "x mandatory", WebkitOverflowScrolling: "touch", paddingBottom: 4 }}>
            ...
            <PhaseFrame
              ...
              phaseScore={phases?.midShot ?? score}
            />
            <PhaseFrame
              ...
              phaseScore={phases?.followThrough}
            />
          </div>
      ...
      {hasAnyThumb && skeletonLandmarks && jointStatus && planTier !== "pro" && (
        <button
          onClick={onUpgrade}
...
function PhaseFrame({ label, thumb, aspect, skeleton, handedness, showSkeleton, phaseScore }) {
  ...
  return (
    ...
    >
      ...
      {hasSkeleton && <SkeletonOverlay landmarks={skeleton.landmarks} jointStatus={skeleton.jointStatus} jointDetail={skeleton.jointDetail} handedness={handedness} />}
