...
const TIERS = [
  {
    ...
    name: "Free",
    price: "₹0",
    points: ["Video analyze — batting/bowling/fielding", "30-day practice plan", "Ads dikhenge har feature me"],
  },
  {
    id: "basic",
    name: "Basic",
    ...
    points: ["3 videos/day analysis", "Apna vs apna purana video compare", "Ads-free analysis screens"],
  },
  {
    id: "pro",
    name: "Pro Compare",
    price: "₹299/mo",
    alt: "ya ₹10 / video compare",
    points: ["10 videos/day analysis", "International players se compare", "Side-by-side + slow-mo overlay", "Joint-by-joint breakdown (head, elbow, knee...)"],
    featured: true,
  },
];
