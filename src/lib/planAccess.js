export const PLAN_TIERS = { FREE: 'free', PRO_99: 'pro_99', VIDEO_499: 'video_499', SPECIAL_COACH: 'special_999' };
export const PLAN_ORDER = ['free', 'pro_99', 'video_499', 'special_999'];
export const PLAN_INFO = {
  ...
  special_999: { name: 'Special Coaching', price: 999, visual: true, video: true, progress: true, compare: 'advanced', coachChat: true },
};
