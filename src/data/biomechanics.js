...
export function evaluatePoseSequence(frames, category, handedness = "right") {
  ...
  if (perFrame.length >= 4) {
    ...
    stance = scoreAngles(stanceAngles, STANCE_RANGES[category], category, "stance");
    ...
    followThrough = scoreAngles(ftAngles, FOLLOW_THROUGH_RANGES[category], category, "followThrough");
  }
